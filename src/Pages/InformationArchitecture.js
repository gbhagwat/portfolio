...
export function InformationArchitecture() {
 const home = false;
 const prev = "/about";
 const next = "/ux-principles";
 const prevText = "Previous | About";
 const nextText = "UX Practices & Principles | Next";
    ...
    <div className="container pt-5">
        ...
        <input type="radio" name="my_tabs_1" role="tab" className="tab" aria-label="Sherwin-Williams" defaultChecked />
            <div role="tabpanel" className="tab-content">
                <div className="card card-bordered">
                    ...
                    <h2>Sherwin-Williams Redesign</h2>
                ...
                <div className="card card-bordered">
                    ...
                    <h4 className="card-subtitle mt-4 mb-2 text-muted">Internal & External Target Audiences</h4>
                    ...
                    <h4 className="card-subtitle mt-4 mb-2 text-muted">Business Goals</h4>
                    <ul className='list-disc ml-4'>
                    ...
                    <h4 className="card-subtitle mt-4 mb-2 text-muted">User Goals</h4>
                    <ul className='list-disc ml-4'>
        ...
        <input type="radio" name="my_tabs_1" role="tab" className="tab" aria-label="Philips Healthcare" />
            <div role="tabpanel" className="tab-content">
                <div className="card card-bordered">
                    <div className="card-body">
                        <h2>Philips Information Architecture</h2>
        ...
        <input type="radio" name="my_tabs_1" role="tab" className="tab" aria-label="Arduino CC" />
            <div role="tabpanel" className="tab-content">
                <div className="card card-bordered">
                    <div className="card-body">
                    <h2>Arduino.cc Information Architecture</h2>
        ...
        <input type="radio" name="my_tabs_1" role="tab" className="tab" aria-label="CHC Physical Therapy" />
            <div role="tabpanel" className="tab-content">
                <div className="card card-bordered">
                    <div className="card-body">
                        <h2>CHC Physical Therapy Redesign</h2>
                        <blockquote className="blockquote">
                ...
                <div className="card card-bordered">
                    <div className="card-body">
                        ...
                        <h4 className="card-subtitle mt-4 mb-2 text-muted">Target Audience</h4>
                        ...
                        <h4 className="card-subtitle mt-4 mb-2 text-muted">Personas</h4>
                        <div className="row justify-content-between">
                            <div className="col-auto">
                            <h5 className="card-subtitle mt-1 mb-2 text-muted">The Young Athlete</h5>
                                <img
                                src={Maria}
                            ...
                            <div className="col-auto">
                                <h5 className="card-subtitle mt-1 mb-2 text-muted">The Weekend Warrior</h5>
                                <img
                                src={Adam}
                        ...
                        <h4 className="card-subtitle mt-4 mb-2 text-muted">Look & Feel</h4>
                ...
                <div className="card card-bordered">
                    <div className="card-body">
                        ...
                        <div className="row justify-content-between">
                            <div className="col-auto">
                                <h4 className="card-subtitle mt-4 mb-2 text-muted">Brand Message Concept Map</h4>
                                <img 
                                    src={CHC}
                                    alt="CHC Brand" 
                                    className="img-fluid" 
                                ...
                                <h4 className="card-subtitle mt-4 mb-2 text-muted">Wirefames & Mockups</h4>
