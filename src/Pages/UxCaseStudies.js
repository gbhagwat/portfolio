            ...
            <section id="case-studies">
                <div class="container pt-5">
                    ...
                    <ol>
                        ...
                        <li>If their needs match the provider’s services and they feel trust and bonding from their experience thus far, they would want to know if they can afford what the provider has to offer. <em>Fees should always be upfront and transparent to remove any unnecessary anxiety.</em> Financial reasons should not be the reason a patient does not get the help they are seeking. If this is a major deciding factor, they can always visit the Fees page without any friction as it is quite clear in the menu items.
                        </li>
                        
                        <li>
                        In this step, the care seeker should have a pretty solid idea if they want to seek help from this provider. The Contact page would provide them with the first action step in either reaching out or scheduling their first appointment. <em>There should be instant feedback on what to expect next.</em> A clearly defined timeline when they might hear back from the provider or that their appointment is official and there are no additional steps needed for them to take.
                        </li>
                        
                        <li>
                        If they have chosen to take that step to contact the provider, the Resources page could provide instant information confirming they have made the right decision as their provider is resourceful and thoughtful with this extra information or even <em>further clear their mind about what they are experiencing with helpful content</em>. There could be content to further educate themselves on their condition, what steps they can take by themselves now to get instant relief and where else they can find help.
                        </li>
                        
                        <li>
                        The Clients page could house all the new patient forms and billing and forms for existing customers. This would show all the pertinent documentation.  If the care seeker has become a Client, there could be a FAQs section for answering the most sought after questions from clientele.
                        </li>
                    </ol>
        ...
        <p>The users will be provided with links to the next section as page navigation on the bottom of each page to gently guide them through their decision making journey.</p>
                        ...
                        <div class="row">
                            ...
                            <p>Unfortunately, due to the nature of my employment, there is very little that I can share to the public.
                                <em
                                    >It's very disheartening as I can't display 7 years of 
                                    design and development over 20 projects as a demonstration of my work.</em
                                >. I would love for my portfolio to land me a job where I can finally
                                ...
                                />
                                <span class="caption">My Portfolio 2018</span>
                            </div>
                            <div class="card card-bordered p-4 mt-2">
                            ...
                            <div class="card card-bordered p-4 mt-2">
                                ...
                                <ul>
                                <li>
                                    The hiring process ignited the spark to breathe new life into my portfolio.
                                </li>
                                <li>
                                    It gave me the opportunity to move the content of
                                    gabriellezwilling.com to gabriellebhagwat.com after 8 years.
                                </li>
                                <li>
                                    Unfortunately, applying to U.S. Digital Services triggered this redesign; I ended up staying within CACI.
                                </li>
                                </ul>
                                ...
                                />
                                <span class="caption">The Final Product 2022</span>
                            </div>
                            <div class="card card-bordered p-4 mt-2">
