        ...
        <div>
            <section id="ux-principles">
                <div className="container pt-5">
                    <h1 className="mb-3">UX Practice & Principles</h1>
                                    ...
                                    <div role="tablist" className="tabs tabs-bordered">
                                        ...
                                        <div role="tabpanel" className="tab-content">
                                            ...
                                            <div class="card card-bordered">
                                                <div class="card-body">
                                                    <h3 class="card-title">User and Stakeholder Research</h3>
                                                    ...
                                                    <table className="table table-zebra table-hover ">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <p >Sample Items</p>
                                                            <ul><li>What is the most difficult step on the site?</li><li>What is easy to use on the site?</li><li>What's wrong with this design?</li><li>What is your favorite site based on design?</li></ul>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <p>Sample Items</p><ul><li>Where the student gets stuck on the site</li><li>Where the student looks frustrated</li><li>How many times they click the back button</li><li>What tasks were handled with ease</li></ul>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <p>Sample Items</p><ul><li>Search options</li><li>Course listings</li><li>Student schedule</li><li>Add/Drop Course options</li></ul>
                                        ...
                                        <div role="tabpanel" className="tab-content">
                                            ...
                                            <div class="card card-bordered">
                                                <div class="card-body">
                                                <h3 class="card-title">Summary of Feedback</h3>
                                            ...
                                            <div class="card card-bordered">
                                                <div class="card-body">
                                                <h3 class="card-title">Summary of Goals for User Interface</h3>
                                            ...
                                            <div class="card card-bordered">
                                                <div class="card-body">
                                                    ...
                                                    <div className="card card-bordered">
                                                        <div className="card-body">
                                                        <h4 class="card-title">Introverted</h4>
                                                    ...
                                                    <div className="card card-bordered">
                                                        <div className="card-body">
                                                        <h4 class="card-title">Indecisive</h4>
                                                    ...
                                                    <div className="card card-bordered">
                                                        <div className="card-body">
                                                        <h4 class="card-title">Independent</h4>
                                                    ...
                                                    <div class="card card-bordered">
                                                        ...
                                                        <h3 className="card-title">Design Principles</h3>
                                                            <div className="card card-bordered">
                                                                <div className="card-body">
                                                                <h4 className="card-title">Straight-forward</h4>
                                                            ...
                                                            <div className="card card-bordered">
                                                                <div className="card-body">
                                                                <h4 className="card-title">Enjoyable</h4>
                                                                    <ul className="list-disc ml-5">
                                        ...
                                        <div role="tabpanel" className="tab-content">
                                            ...
                                            <div className="card card-bordered">
                                                <div className="card-body">
                                                    <em className="mb-2">Designing Something New Based on Your Understanding of the Design Problem</em>
                                        ...
                                        <div role="tabpanel" className="tab-content">
                                            <h2>iNform</h2>
                                            <em className="mb-2">Communicating Your Designs to Stakeholders, Developers and Others</em>
                        ...
                        <h2>UX Deliverables</h2>
                            ...
                            <div role="tablist" className="tabs tabs-bordered">
                                ...
                                <div role="tabpanel" className="tab-content">
                                    ...
                                    <ul><li><strong>Labeling Conventions. </strong>Are they universal among students? Would that help them find what they were looking for more easily?</li>
                                    ...
                                    <li><strong>Search Functionality.</strong> To examine the site specific searchability.</li></ul>
