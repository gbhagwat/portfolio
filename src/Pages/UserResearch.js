...
export function UserResearch() {
    const home = false;
    const prev = "/usability-study";
    const next = "/resume";
    const prevText = "Previous | Usability Study";
    const nextText = "Resume | Next";
    return (
        <div>
      <section id="user-research">
        <div className="container pt-5">
          <h1 className="mb-3 turquoise-bottom">User Research</h1>
            <div className="row">

            <h2>Major Hotel Chain Redesign</h2>
                ...
                <div role="tablist" className="tabs tabs-bordered">
                    ...
                    <div role="tabpanel" className="tab-content">
                    <h3>Research Goals & Questions</h3>
                      ...
                      <h4>User Experience Questions</h4>
                      <ul className="list-disc ml-5">
                      ...
                      <h4>User Research Issues Identified</h4>
                        <ol className="list-decimal -ml-3">
                            <li className="blue mt-1">Increase hotel bookings via digital properties by 10%</li>
                            ...
                            <li className="blue">Increase reservations for their luxury hotel categories</li>
                            ...
                            <li className="blue">Gain 10,000 incremental members of the loyalty program in the first quarter after the redesign</li>
                            ...
                            <li className="blue">Decrease by 20% the number of people starting and then abandoning a reservation </li>
                            ...
                            <li className="blue"> Increase by 5% the number of people choosing a hotel and flight package (vs. just booking their hotel alone)</li>
                        ...
                        <h4 id="uxd-goals">User Research Research Goals</h4>
                        <ul className="list-disc ml-5">
                        ...
                        <h4>General Research Questions</h4>
                        <ul className="list-disc ml-5">
                        ...
                        <h4>Specific Research Questions</h4>
                        <ul className="list-disc ml-5">
                    ...
                    <div role="tabpanel" className="tab-content">
                    <h3>The Interview Plan</h3>
                    <h4>Questions Based on <a href="#goals">User Research Goals</a></h4>
                    <ol className="list-decimal ml-5">
                        <li className="blue">To increase hotel bookings via digital properties</li>
                        <ul className="list-disc ml-5">
                        ...
                        <li className="blue">To increase reservations for luxury and Lifestyle Choice hotel brands</li>
                        <ul className="list-disc ml-5">
                        ...
                        <li className="blue">To prevent users from abandoning the reservation process</li>
                        <ul className="list-disc ml-5">
                        ...
                        <li className="blue">To gain members for the loyalty program</li>
                        <ul className="list-disc ml-5">
                            <li>What rewards do customers find most valuable in a hotel rewards program? </li>
                        <li>What features do member users value?</li>
                        </ul>
                        
                        <li className="blue">To increase number of hotel/flight package bookings as compared to booking a hotel alone</li>
                        <ul className="list-disc ml-5">
                    ...
                    <div role="tabpanel" className="tab-content">
                        <h3>Analyze & Communicate Findings</h3>
